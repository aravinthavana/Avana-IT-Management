        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Bulk Change Asset Status">
            <form onSubmit={handleConfirm} className="space-y-4">
                ...
                <div className="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3 pt-4 gap-3">
                    ...
                    <button type="submit" className="w-full sm:w-auto flex justify-center bg-brand-600 text-white px-5 py-2 rounded-lg hover:bg-brand-700 font-medium transition-all duration-200 active:scale-95">Update Status</button>
                </div>
            </form>
        </Modal>
    );
