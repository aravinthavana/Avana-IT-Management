        ...
        <div className="space-y-8 animate-fade-in">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
                ...
                <div className="flex gap-2">
                    ...
                    {user?.role === 'Admin' && (
                        <button onClick={() => navigate('users')} className="px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white rounded-xl text-sm font-medium shadow-sm transition-all flex items-center gap-2">
                            {ICONS.add} Add User
                        </button>
                    )}
                </div>
