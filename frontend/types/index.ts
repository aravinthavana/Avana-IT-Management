...
export interface AssetRequest {
    ...
    userId: number;
    managerId?: number;
    requestType: 'New Asset' | 'Replacement' | 'Upgrade' | 'Repair' | string;
    category: string;
    priority?: 'Low' | 'Medium' | 'High' | 'Urgent' | string;
    description?: string;
    currentAssetId?: number | null;
    currentAsset?: Asset | null;
    allocatedAssetId?: number | null;
    allocatedAsset?: Asset | null;
    status: 'Pending Manager' | 'Pending Admin' | 'Approved' | 'Fulfilled' | 'Rejected by Manager' | 'Rejected by Admin' | string;
